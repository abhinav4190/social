...
import 'package:social/features/auth/view/screens/verify_screen.dart';
...
class AppRouter {
  static final router = GoRouter(
    initialLocation: _initialLocation(), // Set the initial route based on onboarding completion
    routes: [
      GoRoute(
